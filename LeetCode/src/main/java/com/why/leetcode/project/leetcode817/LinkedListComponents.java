package com.why.leetcode.project.leetcode817;
...
public class LinkedListComponents {
    ...
    public static void main(String[] args) {
        ListNode listNode = new ListNode(0,new ListNode(1,new ListNode(2,new ListNode(3,new ListNode(4)))));
        int[] arr = new int[]{0,3,1,4};
        System.out.println(numComponents(listNode , arr));
    }
